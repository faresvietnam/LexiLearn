...
This work does not add Gemini, Vercel Functions, CSV, moderation transactions, calibration, or adaptive Stage 4. Gemini/Vercel is a separate Phase 3 task after FSRS is stable.
